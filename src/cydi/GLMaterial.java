...
public class GLMaterial {
    ...
    /**
     * Set the material to OpenGL's default values (gray, with no reflection and
     * no glow)
     */
     ...
     */
    /**
     * Set the diffuse material color. This is the color of the material where
     * it is directly lit.
     */
    ...
    /**
     * Set the ambient material color. This is the color of the material where
     * it is lit by indirect light (light scattered off the environment). Ie.
     * the shadowed side of an object.
     */
    ...
    /**
     * Set the specular material color. This controls how much light is
     * reflected off a glossy surface. This color value describes the brightness
     * of the reflection and is typically a shade of gray. Pure black means that
     * no light is reflected (ie. a very rough matte surface). Pure white means
     * that the surface is highly reflective,
     *
    ...
    /**
     * Set the emission material color. This controls the "glow" of the
     * material, and can be used to make a material that seems to be lit from
     * inside.
     */
    ...
    /**
     * Set size of the reflection highlight. Must also set the specular color
     * for shininess to have any effect: setSpecular(GLMaterial.colorWhite);
     *
     * @param howShiny How sharp reflection is: 0 - 127 (127=very sharp
     * pinpoint)
     */
     ...
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
     *
     * The following functions provide a simpler way to use materials that hides
     * some of the complexity of the OpenGL functions.
     *
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
     */
    /**
     ...
     *
     * Use the same color for diffuse and ambient. To create a shadowed effect
     * you should lower the ambient value for the light sources and lower the
     ...
     * describes the brightness of the reflection, and is a shade of gray. This
     * function takes two params that describe the intensity of the reflection,
     * and the size of the highlight.
     *
    ...
    /**
     * alpha value is set in the diffuse material color. Other material colors
     * (ambient, specular) are not affected by alpha value.
     *
     * @param alphaVal 0 - 1
     */
    ...
    /**
     * set the material name. This is the name assigned to this texture in the
     * .mtl file. It is NOT a filename.
     *
     * @param s
     */
